...
let
  ...
  nextjsExtensions = import ./nextjs.nix { inherit pkgs; };
  allExtensions = gitExtensions ++ htmlCssExtensions ++ jsTsExtensions ++ markdownExtensions ++ universalExtensions ++ userExtensions ++ nextjsExtensions ;
